...
function Allocate() {
  ...
  return (
      <div className='min-w-[327px] max-w-[1300px] px-6 mx-auto'>
          <div className=' bg-[url(/section13.png)] bg-no-repeat bg-cover   rounded-3xl   mx-auto h-[480px] md:h-[500px]  flex  items-center   px-6'>
              <div className='md:ml-20 space-y-3'>
                  ...
                  <ul className='flex flex-col md:flex-row md:gap-1 gap-2 md:pt-20 pt-4'>
                      {items.map((item, index) => (
                          <li key={index} className='hover:shadow-md   hover:shadow-primary/20 hover:-translate-y-3 transition-all cursor-pointer'>
